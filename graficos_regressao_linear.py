...
def grafico_ajuste_linear(valores_x:list, valores_y:list, coeficiente_angular:float, coeficiente_linear:float) -> None:
    ...
    plt.plot([x_min, x_max], [y_min, y_max], color='red', label='Reta de Ajuste Linear')
